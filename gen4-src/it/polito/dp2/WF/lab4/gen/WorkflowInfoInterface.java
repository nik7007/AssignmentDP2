...
/**
 * 
 *             This interface provides only operations to get all the processes and workflow fro the
 *             serve
 *         
 * 
...
public interface WorkflowInfoInterface {
    ...
    /**
     * 
     *                 This operation allows the client to get the name of all the workflow in the server. Each
     *                 workflow is characterized by its name.
     *                 The sever doe not only send a list of names but also a date which indicates the last time that the
    ...
    /**
     * 
     *                 With the parameter "getProcessName" the client sends the te server a list of
    ...
    /**
     * 
     *                 The server recive a sequence of workflow's names and send to the client all the workflow
